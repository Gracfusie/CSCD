...
//      Pipeline:       No
//
//      Creation Date:  2018-03-22 16:53:48Z
//      Version: 	2006Q4V1
//
...
`timescale 1 ns/1 ps
`celldefine
module RA1SHD_2048x32M8_dcache #(
   parameter INIT_FILE = "../../rtl/cv32e40p/fpga/tb/dcache.hex"
)
(
   Q,
   CLK,
   ...
   initial begin
      for (int i = 0; i < word_depth; i = i + 1) begin
         mem[i] = {BITS{1'b0}};
      end
      if (INIT_FILE != "") begin
